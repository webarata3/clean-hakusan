const padStart0 = (value: number, length: number): string => String(value).padStart(length, '0');
...
const toDayName = (value: number): string => ['日', '月', '火', '水', '木', '金', '土'][value];
...
export { diffDate, formatDateJa, formatDateYyyymmdd, parseDateYyyymmdd };
